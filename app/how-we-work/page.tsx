...
const HowWeWork = () => {
  ...
  return (
    <div className="min-h-screen bg-[hsl(0_0%_2%)]">
      <Header />
      <main className="pt-24">
        <section id="our-process" className="pb-20">
          <div className="container mx-auto px-6">
            <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-[linear-gradient(160deg,_hsl(0_0%_3%)_0%,_hsl(220_32%_7%)_55%,_hsl(0_0%_3%)_100%)] p-6 md:p-10 process-grid-bg">
              <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_14%_18%,_hsl(204_100%_56%/0.14)_0%,_transparent_42%),radial-gradient(circle_at_85%_82%,_hsl(204_100%_56%/0.08)_0%,_transparent_42%)]" />
              ...
              <div className="relative z-10 overflow-x-auto pb-3 hide-scrollbar">
                <div className="min-w-max flex items-start">
                  {steps.map((step, idx) => (
                    <div key={`flow-${step.title}`} className="flex items-center">
                      <article className="group process-step-panel w-[290px] md:w-[320px] p-5 md:p-6 rounded-xl border border-white/12 bg-black/25 backdrop-blur-md shadow-[0_18px_45px_rgba(0,0,0,0.35)] transition-all duration-300 hover:-translate-y-1.5 hover:shadow-[0_24px_55px_rgba(5,148,255,0.14)]">
                      ...
                      {idx < steps.length - 1 && (
                        <div className="w-16 md:w-20 lg:w-24 px-2">
                          <div className="h-[2px] process-data-line rounded-full" />
                        </div>
                      )}
                    </div>
                  ))}
        ...
        <section id="our-team" className="pb-20">
          <div className="container mx-auto px-6">
            ...
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight-custom text-gradient mb-8">
              The Minds Behind NexviaTech
            </h2>
        ...
        <section className="pb-20">
          <div className="container mx-auto px-6">
            <div className="glass border-glow rounded-xl p-6 md:p-8">
              <p className="section-label mb-3">FAQs</p>
              <h2 className="text-3xl md:text-4xl font-bold tracking-tight-custom text-gradient mb-6">
